(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('opengatewayApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-opengatewayApp-error');
                var entityKey = httpResponse.headers('X-opengatewayApp-params');
                if (errorHeader) {
