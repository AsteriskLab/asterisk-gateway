...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "opengateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "opengateway API";

        private String description = "opengateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "opengateway";
